...
function hestia_the_header_content() {
	...
	/**
	 * TODO: Add style on hestia_left, hestia_center and hestia_right classes for header layout
	 */
	...
	/**
	 * TODO: Add style on full-screen-menu class for displaying hamburger menu all the time
	 */
